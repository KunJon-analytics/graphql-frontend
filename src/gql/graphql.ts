...
export type RegularPostFragment = { __typename?: 'Post', id: number, title: string, createdAt: string, updatedAt: string, voteStatus?: number | null, text: string, points: number, creatorId: number, creator: { __typename?: 'User', id: number, email: string, username: string } };
...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, title: string, createdAt: string, updatedAt: string, voteStatus?: number | null, text: string, points: number, creatorId: number, creator: { __typename?: 'User', id: number, email: string, username: string } } };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, title: string, createdAt: string, updatedAt: string, voteStatus?: number | null, text: string, points: number, creatorId: number, creator: { __typename?: 'User', id: number, email: string, username: string } }> } };
